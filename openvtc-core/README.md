...
(`openvtc` and `did-git-sign`) depend on. It defines the data structures,
cryptographic routines, and protocol constants needed to operate within
the Linux Foundation's decentralized trust infrastructure.
